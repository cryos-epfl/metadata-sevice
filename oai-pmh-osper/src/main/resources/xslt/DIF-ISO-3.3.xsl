...
<!-- Many revisions and suggestions to version 2.1, resulting in version 3.0, made by Ted Habermann and Anna Milan -->
<!-- Released on the 5th of June, 2008.  Last updated on the 5th of December, 2013 -->
<!-- Version 3.3 -->
<!-- ====================================================== -->
  ...
  <!--<xsl:strip-space elements="*"/> -->
						...
						<xsl:if test=".='DIF AUTHOR'">
							<gmd:contact>
								<gmd:CI_ResponsibleParty>
									<gmd:individualName>
										<gco:CharacterString>
											<xsl:value-of select="../dif:Last_Name"></xsl:value-of>, <xsl:value-of select="../dif:First_Name"></xsl:value-of><xsl:text> </xsl:text><xsl:value-of select="../dif:Middle_Name"></xsl:value-of>
										</gco:CharacterString>
									</gmd:individualName>
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
		...
		<gmd:identificationInfo>
			<gmd:MD_DataIdentification>
              ...
              <gmd:edition>
                <gco:CharacterString>
                  <xsl:value-of select="dif:Data_Set_Citation/dif:Version"/>
						...
						<xsl:if test="dif:Data_Set_Citation/dif:Dataset_DOI!=''">
              <gmd:identifier>
                <gmd:MD_Identifier>
                  <gmd:authority>
                    <gmd:CI_Citation>
                  ...
                  <gmd:code>
                    <gco:CharacterString>
                      <xsl:value-of select="dif:Data_Set_Citation/dif:Dataset_DOI"/>
                    </gco:CharacterString>
                  </gmd:code>
                </gmd:MD_Identifier>
              </gmd:identifier>				
						...
						<xsl:for-each select="dif:Extended_Metadata/dif:Metadata">
              <xsl:if test="dif:Name='metadata.uuid'">
                <gmd:identifier>
                  <gmd:MD_Identifier>
                    <gmd:code>
                      <gco:CharacterString>
              ...
              <xsl:for-each select="dif:Data_Set_Citation">
				...
				<gmd:abstract>
					<gco:CharacterString>
						<xsl:value-of select="dif:Summary/dif:Abstract"/>
					</gco:CharacterString>
				</gmd:abstract>
				
				<xsl:if test="dif:Summary/dif:Purpose!=''">
          <gmd:purpose>
            <gco:CharacterString>
              <xsl:value-of select="dif:Summary/dif:Purpose"/>
            </gco:CharacterString>
          </gmd:purpose>
				</xsl:if>
				...
				<gmd:descriptiveKeywords>
					<gmd:MD_Keywords>
						<xsl:for-each select="dif:Parameters">
							<gmd:keyword>							
								<gco:CharacterString>
									<xsl:value-of select="dif:Category"/> &gt; <xsl:value-of select="dif:Topic"/> <xsl:if test="dif:Term!=''"> &gt; <xsl:value-of select="dif:Term"/> </xsl:if> <xsl:if test="dif:Variable_Level_1!=''"> &gt; <xsl:value-of select="dif:Variable_Level_1"/> </xsl:if> <xsl:if test="dif:Variable_Level_2!=''"> &gt; <xsl:value-of select="dif:Variable_Level_2"/> </xsl:if> <xsl:if test="dif:Variable_Level_3!=''"> &gt; <xsl:value-of select="dif:Variable_Level_3"/> </xsl:if>
								</gco:CharacterString>
							</gmd:keyword>
						</xsl:for-each>
						<gmd:thesaurusName>
          ...
          <gmd:descriptiveKeywords>
            <gmd:MD_Keywords>
              <xsl:for-each select="dif:Sensor_Name">
                <gmd:keyword>
                  <gco:CharacterString>
                    <xsl:value-of select="dif:Short_Name"/> <xsl:if test="dif:Long_Name!=''"> &gt; <xsl:value-of select="dif:Long_Name"/> </xsl:if>
                  </gco:CharacterString>
                </gmd:keyword>
              </xsl:for-each>	
              <gmd:thesaurusName>
            ...
            <gmd:descriptiveKeywords>
              <gmd:MD_Keywords>
                <xsl:for-each select="dif:Paleo_Temporal_Coverage/dif:Chronostratigraphic_Unit">
                  <gmd:keyword>							
                    <gco:CharacterString>
                      <xsl:value-of select="dif:Eon"/> <xsl:if test="dif:Era!=''"> &gt; <xsl:value-of select="dif:Era"/> </xsl:if> <xsl:if test="dif:Period!=''"> &gt; <xsl:value-of select="dif:Period"/> </xsl:if> <xsl:if test="dif:Epoch!=''"> &gt; <xsl:value-of select="dif:Epoch"/> </xsl:if>
                    </gco:CharacterString>
                  </gmd:keyword>
                </xsl:for-each>
                <gmd:thesaurusName>
          ...
          <xsl:for-each select="dif:Use_Constraints">
            <gmd:resourceConstraints>
              <gmd:MD_LegalConstraints>
				...
				<xsl:if test="dif:Reference/dif:Author!=''">
            <xsl:for-each select="dif:Reference/dif:Author">
                    ...
                    <gmd:CI_Citation>
                      ...
                      <gmd:date>
                        <gmd:CI_Date>
                          <gmd:date>
                            <gco:Date>
                              <xsl:value-of select="../dif:Publication_Date"/>
                            </gco:Date>
                          </gmd:date>
                          <gmd:dateType>
                            <gmd:CI_DateTypeCode
                      ...
                      <xsl:if test="../dif:Edition!=''">
                        <gmd:edition>
                          <gco:CharacterString>
                            <xsl:value-of select="../dif:Edition"/>
                          </gco:CharacterString>
                        </gmd:edition>
                      </xsl:if>
                      ...
                      <xsl:if test="../dif:Report_Number!=''">
                        <gmd:identifier>
                          <gmd:MD_Identifier>
                            <gmd:code>
                              <gco:CharacterString>
                                Report Number <xsl:value-of select="../dif:Report_Number"/>
                              </gco:CharacterString>
                            </gmd:code>
                          </gmd:MD_Identifier>
                        </gmd:identifier>
                      ...
                      <gmd:citedResponsibleParty>
                        <gmd:CI_ResponsibleParty>
                          <gmd:individualName>
                            <gco:CharacterString>
                              <xsl:value-of select="../dif:Author"/>
                            </gco:CharacterString>
                          </gmd:individualName>
                          <gmd:role>
                            <gmd:CI_RoleCode
                      ...
                      <xsl:if test="../dif:Publisher!='' or ../dif:Publication_Place!=''">
                        <gmd:citedResponsibleParty>
                          <gmd:CI_ResponsibleParty>
                            <xsl:if test="../dif:Publisher!=''">
                              <gmd:organisationName>
                                <gco:CharacterString>
                                  <xsl:value-of select="../dif:Publisher"/>
                                </gco:CharacterString>
                              </gmd:organisationName>
                            </xsl:if>
                            <xsl:if test="../dif:Publication_Place!=''">
                              <gmd:contactInfo>
                                <gmd:CI_Contact>
                                  <gmd:address>
                                    <gmd:CI_Address>
                                      <gmd:city>
                                        <gco:CharacterString>
                                          <xsl:value-of select="../dif:Publication_Place"/>
                                        </gco:CharacterString>
                                      </gmd:city>
                                    </gmd:CI_Address>
                                  </gmd:address>
                      ...
                      <xsl:if test="../dif:Series!='' or ../dif:Issue!='' or ../dif:Pages!=''">
                        <gmd:series>
                          <gmd:CI_Series>
                            <xsl:if test="../dif:Series!=''">
                              <gmd:name>
                                <gco:CharacterString>
                                  <xsl:value-of select="../dif:Series"/>
                                </gco:CharacterString>
                              </gmd:name>
                            </xsl:if>
                            <xsl:if test="../dif:Issue!=''">
                              <gmd:issueIdentification>
                                <gco:CharacterString>
                                  <xsl:value-of select="../dif:Issue"/>
                                </gco:CharacterString>
                              </gmd:issueIdentification>
                            </xsl:if>
                            <xsl:if test="../dif:Pages!=''">
                              <gmd:page>
                                <gco:CharacterString>
                                  <xsl:value-of select="../dif:Pages"/>
                                </gco:CharacterString>
                              </gmd:page>
                            </xsl:if>
                          </gmd:CI_Series>
                      ...
                      <xsl:if test="../dif:Other_Reference_Details!=''">
                        <gmd:otherCitationDetails>
                          <gco:CharacterString>
                            <xsl:value-of select="../dif:Other_Reference_Details"/>
                          </gco:CharacterString>
                        </gmd:otherCitationDetails>
                      </xsl:if>

                      <xsl:if test="../dif:Volume!=''">
                        <gmd:collectiveTitle>
                          <gco:CharacterString>
                            Volume <xsl:value-of select="../dif:Volume"/>
                          </gco:CharacterString>
                        </gmd:collectiveTitle>
                      </xsl:if>

                      <xsl:if test="../dif:ISBN!=''">
                        <gmd:ISBN>
                          <gco:CharacterString>
                            <xsl:value-of select="../dif:ISBN"/>
                          </gco:CharacterString>
                        </gmd:ISBN>
                      </xsl:if>
        ...
        <gmd:characterSet>
          <gmd:MD_CharacterSetCode codeListValue="utf8"
            codeList="http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml#MD_CharacterSetCode">utf8</gmd:MD_CharacterSetCode>
              ...
              <xsl:value-of select="translate(normalize-space(.), $uppercase, $smallcase)"/>
						</gmd:MD_TopicCategoryCode>
					</gmd:topicCategory>
				</xsl:for-each>
                          ...
                          <gml:end>
                            <gml:TimeInstant>
                              <xsl:choose>
                                ...
                                <xsl:when test="./dif:Stop_Date=''">
                                  <xsl:attribute name="gml:id">
                                    <xsl:variable name="uid" select="util:toString(uuid:randomUUID())"/>
        ...
        <xsl:choose>
          <xsl:when test="dif:Distribution/dif:Distribution_Format!=''">
            <xsl:for-each select="dif:Distribution/dif:Distribution_Format">
          ...
          <gmd:transferOptions>
            <gmd:MD_DigitalTransferOptions>
			  ...
			  <gmd:onLine xmlns:gmx="http://www.isotc211.org/2005/gmx" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:xlink="http://www.w3.org/1999/xlink">
				<gmd:CI_OnlineResource>
				  <gmd:linkage>
					<gmd:URL>http://data.aad.gov.au/aadc/metadata/metadata_redirect.cfm?md=<xsl:value-of select="dif:Entry_ID"/></gmd:URL>
				  </gmd:linkage>
				  <gmd:protocol>
              ...
              <xsl:if test="dif:Related_URL!=''">
                ...
                <xsl:for-each select="dif:Related_URL/dif:URL_Content_Type">
                  <xsl:for-each select="dif:Subtype">
                    <xsl:if test=".='DATA POOL (ON-LINE ARCHIVE)'">
                      <gmd:onLine>
                        <gmd:CI_OnlineResource>
                          <gmd:linkage>
                            <gmd:URL>
                ...
                <xsl:for-each select="dif:Related_URL/dif:URL_Content_Type">
                  <xsl:for-each select="dif:Type">
                    <xsl:if test=".='GET RELATED VISUALIZATION'">
                      <gmd:onLine>
                        <gmd:CI_OnlineResource>
                          <gmd:linkage>
                            <gmd:URL>
                ...
                <xsl:for-each select="dif:Related_URL/dif:URL_Content_Type">
                  <xsl:for-each select="dif:Type">
                    <xsl:if test=".='VIEW PROFESSIONAL HOME PAGE'">
                      <gmd:onLine>
                        <gmd:CI_OnlineResource>
                          <gmd:linkage>
                            <gmd:URL>
                      ...
                      <gmd:MD_Medium>
                        <gmd:name>
                          <gmd:MD_MediumNameCode
                            codeList="http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml#MD_MediumNameCode"
                            codeListValue="onLine">onLine</gmd:MD_MediumNameCode>
                        </gmd:name>
                      </gmd:MD_Medium>
                    </gmd:offLine>
                  </xsl:if>
                    ...
                    <gmd:offLine>
                      <gmd:MD_Medium>
                        <gmd:name>
                          <gmd:MD_MediumNameCode
                            codeList="http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml#MD_MediumNameCode"
                            codeListValue="cdRom">cdRom</gmd:MD_MediumNameCode>
                         </gmd:name>
                      </gmd:MD_Medium>
                    </gmd:offLine>
                  </xsl:if>
                    ...
                    <gmd:offLine>
                      <gmd:MD_Medium>
                        <gmd:name>
                          <gmd:MD_MediumNameCode
                            codeList="http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml#MD_MediumNameCode"
                            codeListValue="dvd">dvd</gmd:MD_MediumNameCode>
                        </gmd:name>
                      </gmd:MD_Medium>
                    </gmd:offLine>
                  </xsl:if>
		...
		<gmd:dataQualityInfo>
          ...
          <xsl:for-each select="dif:Data_Resolution">				
				
            <xsl:for-each select="./dif:Temporal_Resolution">
              <gmd:report>
            ...
            <xsl:for-each select="./dif:Latitude_Resolution">
              <gmd:report>
            ...
            <xsl:for-each select="./dif:Longitude_Resolution">
              <gmd:report>
                <gmd:DQ_AbsoluteExternalPositionalAccuracy>
                  <gmd:nameOfMeasure>
            ...
            <xsl:for-each select="./dif:Vertical_Resolution">
              <gmd:report>
                <gmd:DQ_AbsoluteExternalPositionalAccuracy>
                  <gmd:nameOfMeasure>
